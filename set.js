...
module.exports = { session: process.env.SESSION_ID || 'Gifted;;;',
    ...
    NUMERO_OWNER : process.env.OWNER_NUMBER || "254762016957,254728782591,923475667330", 
...
CHATBOT: process.env.CHAT_BOT || "no",
    ...
    URL : process.env.BOT_MENU_LINKS || 'https://telegra.ph/file/8000f2ffbbf89a5f3ae40.jpg',
